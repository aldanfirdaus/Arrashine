<!-- Modal -->
<div class="modal fade" id="confirmationDelete-{{ $product->id }}" tabindex="-1" role="dialog"
        ...
        <form action="/admin/product/{{ $product->id }}" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmationDeleteLabel">Konfirmasi Hapus Produk</h5>
